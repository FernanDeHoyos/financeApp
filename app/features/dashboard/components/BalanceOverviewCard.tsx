...
export const BalanceOverviewCard = ({ balance, transactions }: BalanceCardProps) => {
      ...
      <Card.Content style={styles.balanceCardContent}>
        ...
        <View style={styles.statsRow}>
          <View style={{ flex: 1 }}>
            ...
            <Text variant="bodyLarge" style={{ color: colors.onPrimaryContainer, fontWeight: '700' }}>{transactions.length}</Text>
          </View>
          <View style={{ flex: 1 }}>
            ...
            <Text variant="bodyLarge" style={{ color: colors.onPrimaryContainer, fontWeight: '700' }}>
              ${(balance / Math.max(transactions.length, 1)).toFixed(0)}
            </Text>
          </View>
        </View>
      </Card.Content>
